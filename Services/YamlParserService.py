...
def parse(yaml_file):
    ...
    group_arrays = [globals.image_captioning_containers,
                    globals.ocr_containers,
                    globals.object_detection_containers,
                    globals.scene_recognition_containers,
                    globals.image_recognition_containers,
                    globals.image_search_containers,
                    globals.face_recognition_containers,
                    globals.sound_classification_containers,
                    globals.audio_fingerprinting_containers,
                    globals.speech_to_text_containers,
                    globals.entity_recognition_containers,
                    globals.search_containers]
    return group_arrays
